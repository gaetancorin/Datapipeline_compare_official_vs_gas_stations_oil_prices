# Z_Score_Visualization

## Prerequisites
To visualize z-score transformation, you need to **load at least a Year in MongoDB with Flask in Local** (because data we use to visualize is temporaly file into Flask outputs folder)
...
3. **Open and Run the notebook**  
   - Launch the notebook and explore the visualizations showing the data **before and after the z-score transformation** directly within the notebook.  
